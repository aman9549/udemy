...
const RecentLearning = () => {
   ...
   const settings = {
  dots: true,
  infinite: true,      // Set this to true for infinite looping
  speed: 500,          // Transition speed between slides
  slidesToShow: 3,
  slidesToScroll: 1,
  autoplay: true,
  autoplaySpeed: 3000, // Time between transitions
  cssEase: "ease-in-out", // "linear" often looks jerky with infinite; "ease-in-out" is smoother
  pauseOnHover: true,  // Good UX: stop scrolling when user is looking at a specific path
  responsive: [
    {
      breakpoint: 1024,
      settings: {
